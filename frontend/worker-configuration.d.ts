/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 77f54319cabadda3596215d3abff1f99)
...
interface __BaseEnv_Env {
	...
	VITE_DEEPBOOK_PACKAGE_ID: string;
	VITE_DEEPBOOK_MARKET_ID: string;
	VITE_DUSDC_COIN_TYPE: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<
		Pick<
			...
			| 'VITE_SUI_NETWORK'
			| 'VITE_SUI_RPC_URL'
			| 'VITE_DEEPBOOK_PACKAGE_ID'
			| 'VITE_DEEPBOOK_MARKET_ID'
			| 'VITE_DUSDC_COIN_TYPE'
