/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 72475118340750871544bcd47155149a)
// Runtime types generated with workerd@1.20260611.1 2026-06-14 nodejs_als,nodejs_compat
interface __BaseEnv_Env {
	VITE_API_BASE_URL: string;
	VITE_STARTING_SOON_HOURS: string;
	VITE_UPCOMING_WINDOW_DAYS: string;
	VITE_LIVE_MAX_HOURS: string;
	VITE_SUI_NETWORK: string;
	VITE_SUI_RPC_URL: string;
	VITE_DUSDC_TYPE: string;
	VITE_SHEKA_MARKET_PACKAGE_ID: string;
	VITE_SHEKA_ANALYSIS_PACKAGE_ID: string;
	VITE_SHEKA_ANALYSIS_REGISTRY_ID: string;
	VITE_SHEKA_ANALYSIS_TREASURY_ID: string;
	VITE_SHEKA_ANALYSIS_QUOTA_ID: string;
	VITE_WALRUS_AGGREGATOR_URL: string;
	VITE_ENOKI_API_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_API_BASE_URL" | "VITE_STARTING_SOON_HOURS" | "VITE_UPCOMING_WINDOW_DAYS" | "VITE_LIVE_MAX_HOURS" | "VITE_SUI_NETWORK" | "VITE_SUI_RPC_URL" | "VITE_DUSDC_TYPE" | "VITE_SHEKA_MARKET_PACKAGE_ID" | "VITE_SHEKA_ANALYSIS_PACKAGE_ID" | "VITE_SHEKA_ANALYSIS_REGISTRY_ID" | "VITE_SHEKA_ANALYSIS_TREASURY_ID" | "VITE_SHEKA_ANALYSIS_QUOTA_ID" | "VITE_WALRUS_AGGREGATOR_URL" | "VITE_ENOKI_API_KEY" | "VITE_GOOGLE_CLIENT_ID">> {}
}
